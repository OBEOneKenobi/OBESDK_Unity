...
public class NodDevice
{
	...
	public void CheckForUpdate()
	{
		...
		if (subscribedTo [(int)NodSubscriptionType.TranslationMode]) {
			NodPosition3D position = deviceInterface.Translation (deviceIndex);
	...
	public bool SendHapticCommand(int hapticIndex, int argument)
	{
		return deviceInterface.SendHapticCommand(deviceIndex, hapticIndex, argument);
	}
}
