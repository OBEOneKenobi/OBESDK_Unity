...
public class NodControllerAndroidImp : NodControllerInterface
{
	...
	private static NodQuaternionOrientation eulerToQuaternion(float roll, float pitch, float yaw)
	{
	...
	public NodPosition3D Translation(int deviceIndex)
	{
		float[] translationArray = unityPlugin.CallStatic<float[]>("getTranslationData", deviceIndex);
		NodPosition3D pos3d;
		pos3d.x = translationArray [0]/1000;
		pos3d.y = translationArray [1]/1000;
		pos3d.z = translationArray [2]/1000;
		return pos3d;
	}
	...
	public bool SendHapticCommand(int deviceIndex, int hapticIndex, int argument)
	{
		return unityPlugin.CallStatic<bool>("sendHaptic", deviceIndex, hapticIndex, argument);
	}
	...
	public bool Subscribe(NodSubscriptionType type, int deviceIndex)
	{
		...
		case NodSubscriptionType.GameControlMode:
			...
			break;
		case NodSubscriptionType.TranslationMode:
			result = unityPlugin.CallStatic<bool> ("registerForTranslationEvents", deviceIndex);
			break;
		default:
	...
	public bool Unsubscribe(NodSubscriptionType type, int deviceIndex)
	{
		...
		case NodSubscriptionType.GameControlMode:
			...
			break;
		case NodSubscriptionType.TranslationMode:
			result = unityPlugin.CallStatic<bool> ("unregisterFromTranslationEvents", deviceIndex);
			break;
		default:
